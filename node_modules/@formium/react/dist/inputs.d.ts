...
export declare const Checkbox: React.NamedExoticComponent<ControlProps>;
export declare const Radio: React.NamedExoticComponent<ControlProps>;
/**
...
/** @public */
export declare type RadioProps = ControlProps;
/** @public */
export declare type CheckboxProps = ControlProps;
/**
 * @public
 */
