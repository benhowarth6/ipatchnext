...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="Choose Your MacBook Repair Booking Type - iPatch"
        description="Choose how you'd like to get your MacBook repaired, we accept both mail in and drop off repairs."
      />
      <Header />
