...
export default function Home() {
  return (
    <div>
      <NextSeo
        title="MacBook Repair Booking Confirmed - iPatch"
        description="Find out what to do once you've booked your MacBook in for repair with us."
      />
      <Header />
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-600">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="max-w-2xl mt-5 mx-auto text-xl text-white">Your MacBook repair has been confirmed, find out what to do next.</p>
          </div>
        </div>
      </div>
