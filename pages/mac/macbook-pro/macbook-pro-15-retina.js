...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="MacBook Pro (Retina, 15-inch) Repairs in Leeds - iPatch"
        description="We repair MacBook Pro (Retina, 15-inch) screens, batteries, keyboards and more. We aim to complete all repairs in the same day and include a 90 day warranty."
      />
      <Navigation />
