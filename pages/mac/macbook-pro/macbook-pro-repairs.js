...
export default function Home() {
  return (
    <div>
      <NextSeo
        title="MacBook Pro Repairs in Leeds | Screen Replacements, Batteries and more"
        description="Expert MacBook Pro repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our MacBook Pro repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/mac/macbook-pro/macbook-pro-repairs"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/mac/macbook-pro/macbook-pro-repairs',
          title: 'MacBook Pro Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert MacBook Pro repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our MacBook Pro repairs include a 3 month warranty.',
          mages: [
            {
              ...
              width: 1200,
              height: 630,
              alt: "iPatch | MacBook Pro Repairs in Leeds"
            }
          ]
        }}
      />
      ...
      <div className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="mt-1 text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl">MacBook Pro Repairs</h1>
            <h2 className="max-w-2xl mt-5 mx-auto text-xl text-white">We offer a large selection of MacBook Pro repairs including screens, batteries, charging ports and more for all models. </h2>
          </div>
        </div>
      </div>
