...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="MacBook Pro 15-inch Unibody Repairs in Leeds | Screen Replacements, Batteries and more"
        description="Expert MacBook Pro 15-inch Unibody repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our MacBook Pro 15-inch Unibody repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/mac/macbook-pro/macbook-pro-15-unibody"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/mac/macbook-pro/macbook-pro-15-unibody',
          title: 'MacBook Pro 15-inch Unibody Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert MacBook Pro 15-inch Unibody repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our MacBook Pro 15-inch Unibody repairs include a 3 month warranty.',
          mages: [
            {
              ...
              width: 1200,
              height: 630,
              alt: "iPatch | MacBook Pro 15-inch Unibody Repairs in Leeds"
            }
          ]
        }}
      />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-3xl font-extrabold text-gray-900 sm:text-4xl lg:text-5xl">
               MacBook Pro (Unibody, 15-inch) Repair
              </h1>
              <h2 className="mt-4 text-xl text-gray-600">
                We offer a comprehensive set of repairs for the  MacBook Pro (Unibody, 15-inch).
              ...
              <div className="max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex">
                <div className="flex-1 bg-white px-6 py-8 lg:p-12">
                  ...
                  <p className="mt-6 text-base text-gray-500">
                    If the glass on the front of your MacBook Pro is cracked, you'll require a new glass.
                  </p>
                  <div className="mt-8">
                    ...
                    <div className="rounded-md shadow">
                      <Link
                        href={{
                          ...
                          query: { model: "macbook-pro-15-unibody", repair: "glass" },
                        }}
                      >
        ...
        <div className="max-w-7xl mx-auto pb-24 px-4 sm:px-6 lg:px-8">
          <div className="sm:flex sm:flex-col sm:align-center">
            ...
            <p className="mt-4 text-xl text-gray-600 sm:text-center">
              Here's all the repairs we offer for  MacBook Pro (Unibody, 15-inch).
            </p>
          </div>
          ...
          <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "lcd" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "battery" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                <h2 className="text-lg leading-6 font-medium text-gray-900">
                  MagSafe Charging Board
                </h2>
                <p className="mt-4 text-sm text-gray-500">
                  A new charging board to restore device charging.
                </p>
                <p className="mt-8">
                  <span className="text-4xl font-extrabold text-gray-900">
                    £120
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "charging-port" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <p className="mt-4 text-sm text-gray-500">
                  A keyboard if yours is damaged or not responding.
                </p>
                <p className="mt-8">
                  <span className="text-4xl font-extrabold text-gray-900">
                    £120
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "keyboard" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "trackpad" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <p className="mt-4 text-sm text-gray-500">
                  A new sata ribbon if your Mac can't detect a boot drive.
                </p>
                <p className="mt-8">
                  <span className="text-4xl font-extrabold text-gray-900">
                    £95
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "sata-ribbon" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <p className="mt-4 text-sm text-gray-500">
                  A new logic board if yours is damaged.
                </p>
                <p className="mt-8">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "logic-board" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "8gb-ram" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "16gb-ram" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "250gb-ssd" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "500gb-ssd" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "1tb-ssd" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="bg-gray-100 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "not-sure" },
                  }}
                >
            ...
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-macbook-repair/booking-type",
                    query: { model: "macbook-pro-15-unibody", repair: "liquid-damage" },
                  }}
                >
                  <a className="mt-8 flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-white hover:bg-gray-50">
                    Book an Inspection
      ...
      <div className="py-16 bg-gray-100 overflow-hidden lg:py-24">
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
          <div className="relative">
            ...
            <p className="mt-4 text-xl text-gray-600 sm:text-center">
              Why repair your  MacBook Pro (Unibody, 15-inch) with iPatch?
            </p>
          </div>
