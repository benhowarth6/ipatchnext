...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="iMac 21-inch Repairs in Leeds | Screen Replacements, SSD Upgrades and more"
        description="Expert iMac 21-inch Repairs in Trinity Leeds. We offer replacement screens, SSD upgrades and more while you wait. All of our iMac 21-inch Repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/mac/imac/imac-21"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/mac/imac/imac-21',
          title: 'iMac 21-inch Repairs in Leeds | Screen Replacements, SSD upgrades and more',
          description: 'Expert iMac 21-inch Repairs in Trinity Leeds. We offer replacement screens, SSD upgrades and more while you wait. All of our iMac 21-inch Repairs include a 3 month warranty.',
          mages: [
            {
              ...
              width: 1200,
              height: 630,
              alt: "iPatch | iMac 21-inch Repairs in Leeds"
            }
          ]
        }}
      />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h2 className="mt-4 text-xl text-gray-600">
                We offer a comprehensive set of repairs for the  iMac (21.5-inch).
                    ...
                    <div className="rounded-md shadow">
                      <Link
                        href={{
                          ...
                          query: { model: "imac-21", repair: "glass" },
                        }}
                      >
        ...
        <div className="max-w-7xl mx-auto pb-24 px-4 sm:px-6 lg:px-8">
          <div className="sm:flex sm:flex-col sm:align-center">
            ...
            <p className="mt-4 text-xl text-gray-600 sm:text-center">
              Here's all the repairs we offer for  iMac (21.5-inch).
            </p>
          </div>
          ...
          <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-imac-repair/booking-type",
                    query: { model: "imac-21", repair: "lcd" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-imac-repair/booking-type",
                    query: { model: "imac-21", repair: "8gb-ram" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-imac-repair/booking-type",
                    query: { model: "imac-21", repair: "16gb-ram" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-imac-repair/booking-type",
                    query: { model: "imac-21", repair: "32gb-ram" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-imac-repair/booking-type",
                    query: { model: "imac-21", repair: "250gb-ssd" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-imac-repair/booking-type",
                    query: { model: "imac-21", repair: "500gb-ssd" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-imac-repair/booking-type",
                    query: { model: "imac-21", repair: "1tb-ssd" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="bg-gray-100 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-imac-repair/booking-type",
                    query: { model: "imac-21", repair: "not-sure" },
                  }}
                >
            ...
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "/mac/book-imac-repair/booking-type",
                    query: { model: "imac-21", repair: "liquid-damage" },
                  }}
                >
                  <a className="mt-8 flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-white hover:bg-gray-50">
                    Book an Inspection
      ...
      <div className="py-16 bg-gray-100 overflow-hidden lg:py-24">
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
          <div className="relative">
            ...
            <p className="mt-4 text-xl text-gray-600 sm:text-center">
              Why repair your  iMac (21.5-inch) with iPatch?
            </p>
          </div>
