...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="Choose Your iMac Repair Booking Type - iPatch"
        description="Choose how you'd like to get your iMac repaired, we accept both mail in and drop off repairs."
      />
      <Navigation />
