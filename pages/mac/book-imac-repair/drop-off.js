...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="Book a Drop-Off iMac Repair in Leeds - iPatch"
        description="Book your iMac in with us for a drop-off repair at one of our Leeds stores using this form."
      />
      <Header />
      ...
      <div className="bg-gray-100">
        <div className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:pb-14 lg:px-8">
          <form
            className="kwes-form"
            action="https://kwes.io/api/foreign/forms/ci165eHq54GGQwTSXcpe"
            redirect="success"
          >
