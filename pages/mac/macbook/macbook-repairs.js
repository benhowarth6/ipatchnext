...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="MacBook Repairs in Leeds | Screen Replacements, Batteries and more"
        description="Expert MacBook repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our MacBook repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/mac/macbook/macbook-repairs"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/mac/macbook/macbook-repairs',
          title: 'MacBook Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert MacBook repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our MacBook repairs include a 3 month warranty.',
          mages: [
            {
              ...
              width: 1200,
              height: 630,
              alt: "iPatch | MacBook Repairs in Leeds"
            }
          ]
        }}
      />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-3xl font-extrabold text-gray-900 sm:text-4xl lg:text-5xl">
                MacBook (Retina, 12-inch) Repair
              </h1>
              <h2 className="mt-4 text-xl text-gray-600">
                We offer a comprehensive set of repairs for the MacBook (Retina, 12-inch).
        ...
        <div className="max-w-7xl mx-auto pb-24 px-4 sm:px-6 lg:px-8">
          <div className="sm:flex sm:flex-col sm:align-center">
            ...
            <p className="mt-4 text-xl text-gray-600 sm:text-center">
              Here's all the repairs we offer for MacBook (Retina, 12-inch).
            </p>
          </div>
      ...
      <div className="py-16 bg-gray-100 overflow-hidden lg:py-24">
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
          <div className="relative">
            ...
            <p className="mt-4 text-xl text-gray-600 sm:text-center">
              Why repair your MacBook (Retina, 12-inch) with iPatch?
            </p>
          </div>
