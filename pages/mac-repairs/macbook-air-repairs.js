...
import models from '../../data/mac/macbook-air-models.json';
      ...
      <div className="bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          <div className="py-24 text-center">
            <h1 className="text-4xl font-extrabold tracking-tight text-gray-900">MacBook Air Repairs</h1>
            <p className="mt-4 max-w-3xl mx-auto text-base text-gray-500">
              We offer a large selection of MacBook Air repairs including screens, batteries, charging ports and more for nearly all models.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white">
        <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <div className="mt-6 grid grid-cols-2 gap-x-8 gap-y-8 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            {models.map(macModel => {
              const { id, name, image, alt, href } = macModel;
              return (
            ...
            <dl className="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-10">
              <div>
                <dt className="text-lg leading-6 font-medium text-gray-900">
                  How do I get my MacBook Air Repaired?
                </dt>
                <dd className="mt-2 text-base text-gray-500">
                  ...
                  services. If you aren’t sure which repair your MacBook Air
              ...
              <div>
                ...
                <dd className="mt-2 text-base text-gray-500">
                  ...
                  and the model of MacBook Air. We list nearly all repair costs for
                  the the MacBook Air's we offer service on. Should you not be able
              ...
              <div>
                ...
                <dd className="mt-2 text-base text-gray-500">
                  ...
                  A drop off repair for your MacBook Air is the quickest way to get
                  your device repaired, and we usually complete nearly all
                  MacBook Air repairs in a couple of hours. Should you want to mail in
              ...
              <div>
                ...
                <dd className="mt-2 text-base text-gray-500">
                  We offer a wide range of repairs for all MacBook Air models,
                  however should a repair not be possible on your device you
                  can collect your MacBook Air with no fee or just the return postage
              ...
              <div>
                ...
                <dd className="mt-2 text-base text-gray-500">
                  MacBook Air screen replacements are our most common repair, we can
              ...
              <div>
                ...
                <dd className="mt-2 text-base text-gray-500">
                  MacBook Air batteries have a limited life span, this is usually
