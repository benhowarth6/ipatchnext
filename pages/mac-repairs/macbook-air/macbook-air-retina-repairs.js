...
const product = {
  name: 'MacBook Air Retina Repairs',
  model: 'MacBook Air Retina',
  description: "We offer a comprehensive set of repairs for the MacBook Air Retina. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the MacBook Air Retina. Including screen replacements, batteries and much more.",
  imageSrc: '/mac/devices/macbook-air-retina.jpg',
  imageAlt: 'Image of an MacBook Air Retina.',
  imageAlt2: 'Image of the rear of an MacBook Air Retina.',
  breadcrumbs: [
    { id: 1, name: 'Mac Repairs', href: '/mac-repairs' },
    { id: 2, name: 'MacBook Air Repairs', href: '../macbook-air-repairs' },
    { id: 3, name: 'MacBook Air Retina', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/mac-repairs/macbook-air/macbook-air-retina-repairs" />
