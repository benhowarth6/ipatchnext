...
const product = {
  name: 'MacBook Air 13-inch Repairs',
  model: 'MacBook Air 13-inch',
  description: "We offer a comprehensive set of repairs for the MacBook Air 13-inch. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the MacBook Air 13-inch. Including screen replacements, batteries and much more.",
  imageSrc: '/mac/devices/macbook-air-13.jpg',
  imageAlt: 'Image of an MacBook Air 13-inch.',
  imageAlt2: 'Image of the rear of an MacBook Air 13-inch.',
  breadcrumbs: [
    { id: 1, name: 'Mac Repairs', href: '/mac-repairs' },
    { id: 2, name: 'MacBook Air Repairs', href: '../macbook-air-repairs' },
    { id: 3, name: 'MacBook Air 13-inch', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/mac-repairs/macbook-air/macbook-air-13-repairs" />
