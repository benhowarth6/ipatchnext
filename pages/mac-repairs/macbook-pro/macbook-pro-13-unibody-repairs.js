...
const product = {
  ...
  imageAlt: 'Image of an MacBook Pro 13-inch Unibody.',
  imageAlt2: 'Image of the rear of an MacBook Pro 13-inch Unibody.',
  breadcrumbs: [
    { id: 1, name: 'Mac Repairs', href: '/mac-repairs' },
    { id: 2, name: 'MacBook Pro Repairs', href: '../macbook-pro-repairs' },
    { id: 3, name: 'MacBook Pro 13-inch Unibody', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/mac-repairs/macbook-pro/macbook-pro-13-unibody-repairs" />
