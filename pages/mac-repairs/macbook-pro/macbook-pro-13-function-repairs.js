...
import Details from "../../../components/mac-repair/Details";
import Incentives from "../../../components/mac-repair/Incentives";
import Footer from "../../../components/Footer";

import repairs from "../../../data/mac/mac-repairs.json";

const product = {
  name: 'MacBook Pro 13-inch Function Key Repairs',
  model: 'MacBook Pro 13-inch Function Key',
  description: "We offer a comprehensive set of repairs for the MacBook Pro 13-inch Function Key. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the MacBook Pro 13-inch Function Key. Including screen replacements, batteries and much more.",
  imageSrc: '/mac/devices/mbp-13-function.jpg',
  imageAlt: 'Image of an MacBook Pro 13-inch Function Key.',
  imageAlt2: 'Image of the rear of an MacBook Pro 13-inch Function Key.',
  breadcrumbs: [
    { id: 1, name: 'Mac Repairs', href: '/mac-repairs' },
    { id: 2, name: 'MacBook Pro Repairs', href: '../macbook-pro-repairs' },
    { id: 3, name: 'MacBook Pro 13-inch Function Key', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/mac-repairs/macbook-pro/macbook-pro-13-function-repairs" />
