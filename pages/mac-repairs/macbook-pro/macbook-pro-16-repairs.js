...
const product = {
  name: 'MacBook Pro 16-inch Repairs',
  device_model: '16-inch',
  description: "We offer a comprehensive set of repairs for the MacBook Pro 16-inch. Including screen replacements, batteries and much more.",
  ...
  breadcrumbs: [
    ...
    { id: 3, name: 'MacBook Pro 16-inch', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/mac-repairs/macbook-pro/macbook-pro-16-repairs" />
