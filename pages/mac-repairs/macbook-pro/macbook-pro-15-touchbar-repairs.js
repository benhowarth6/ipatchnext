...
const product = {
  name: 'MacBook Pro 15-inch Touchbar Repairs',
  model: 'MacBook Pro 15-inch Touchbar',
  description: "We offer a comprehensive set of repairs for the MacBook Pro 15-inch Touchbar. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the MacBook Pro 15-inch Touchbar. Including screen replacements, batteries and much more.",
  imageSrc: '/mac/devices/mbp-15-touchbar.jpg',
  imageAlt: 'Image of an MacBook Pro 15-inch Touchbar.',
  imageAlt2: 'Image of the rear of an MacBook Pro 15-inch Touchbar.',
  breadcrumbs: [
    { id: 1, name: 'Mac Repairs', href: '/mac-repairs' },
    { id: 2, name: 'MacBook Pro Repairs', href: '../macbook-pro-repairs' },
    { id: 3, name: 'MacBook Pro 15-inch Touchbar', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/mac-repairs/macbook-pro/macbook-pro-15-touchbar-repairs" />
