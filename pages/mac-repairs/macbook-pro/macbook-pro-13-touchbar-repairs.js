...
const product = {
  name: 'MacBook Pro 13-inch Touchbar Repairs',
  model: 'MacBook Pro 13-inch Touchbar',
  description: "We offer a comprehensive set of repairs for the MacBook Pro 13-inch Touchbar. Including screen replacements, batteries and much more.",
  ...
  breadcrumbs: [
    ...
    { id: 3, name: 'MacBook Pro 13-inch Touchbar', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/mac-repairs/macbook-pro/macbook-pro-13-touchbar-repairs" />
