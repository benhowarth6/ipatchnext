...
const product = {
  name: 'MacBook Pro 13-inch Retina Repairs',
  model: 'MacBook Pro 13-inch Retina',
  description: "We offer a comprehensive set of repairs for the MacBook Pro 13-inch Retina. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the MacBook Pro 13-inch Retina. Including screen replacements, batteries and much more.",
  imageSrc: '/mac/devices/mbp-13-retina.jpg',
  imageAlt: 'Image of an MacBook Pro 13-inch Retina.',
  imageAlt2: 'Image of the rear of an MacBook Pro 13-inch Retina.',
  breadcrumbs: [
    { id: 1, name: 'Mac Repairs', href: '/mac-repairs' },
    { id: 2, name: 'MacBook Pro Repairs', href: '../macbook-pro-repairs' },
    { id: 3, name: 'MacBook Pro 13-inch Retina', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/mac-repairs/macbook-pro/macbook-pro-13-retina-repairs" />
