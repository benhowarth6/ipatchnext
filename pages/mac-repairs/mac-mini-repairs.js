...
import models from '../../data/mac/mac-mini-models.json';
            ...
            <dl className="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-10">
              <div>
                <dt className="text-lg leading-6 font-medium text-gray-900">
                  How do I get my Mac Mini Repaired?
                </dt>
                <dd className="mt-2 text-base text-gray-500">
                  ...
                  services. If you aren’t sure which repair your Mac Mini
              ...
              <div>
                ...
                <dd className="mt-2 text-base text-gray-500">
                  ...
                  and the model of Mac Mini. We list nearly all repair costs for
                  the the Mac Mini's we offer service on. Should you not be able
              ...
              <div>
                ...
                <dd className="mt-2 text-base text-gray-500">
                  ...
                  Mac Mini repairs in a couple of hours. Should you want to mail in
              ...
              <div>
                ...
                <dd className="mt-2 text-base text-gray-500">
                  We offer a wide range of repairs for all Mac Mini models,
                  however should a repair not be possible on your device you
                  can collect your Mac Mini with no fee or just the return postage
              ...
              <div>
                ...
                <dd className="mt-2 text-base text-gray-500">
                  Mac Mini screen replacements are our most common repair, we can
              ...
              <div>
                ...
                <dd className="mt-2 text-base text-gray-500">
                  Mac Mini batteries have a limited life span, this is usually
