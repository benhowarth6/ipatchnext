...
const product = {
  name: 'iMac 21.5-inch 4K Repairs',
  model: 'iMac 21.5-inch 4K',
  description: "We offer a comprehensive set of repairs for the iMac 21.5-inch 4K. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iMac 21.5-inch 4K. Including screen replacements, batteries and much more.",
  imageSrc: '/mac/devices/imac-21-4k.jpg',
  imageAlt: 'Image of an iMac 21.5-inch 4K.',
  imageAlt2: 'Image of the rear of an iMac 21.5-inch 4K.',
  breadcrumbs: [
    { id: 1, name: 'Mac Repairs', href: '/mac-repairs' },
    { id: 2, name: 'iMac Repairs', href: '../imac-repairs' },
    { id: 3, name: 'iMac 21.5-inch 4K', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/mac-repairs/imac-repairs/imac-21-4k-repairs" />
