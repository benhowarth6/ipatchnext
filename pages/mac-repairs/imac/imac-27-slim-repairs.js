...
const product = {
  name: 'iMac 27-inch Slim Repairs',
  model: 'iMac 27-inch Slim',
  description: "We offer a comprehensive set of repairs for the iMac 27-inch Slim. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iMac 27-inch Slim. Including screen replacements, batteries and much more.",
  imageSrc: '/mac/devices/imac-27-slim.jpg',
  imageAlt: 'Image of an iMac 27-inch Slim.',
  imageAlt2: 'Image of the rear of an iMac 27-inch Slim.',
  breadcrumbs: [
    { id: 1, name: 'Mac Repairs', href: '/mac-repairs' },
    { id: 2, name: 'iMac Repairs', href: '../imac-repairs' },
    { id: 3, name: 'iMac 27-inch Slim', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/mac-repairs/imac-repairs/imac-27-slim-repairs" />
