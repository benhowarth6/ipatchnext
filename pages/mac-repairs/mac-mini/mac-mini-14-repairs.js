...
const product = {
  name: 'Mac Mini 2014 Repairs',
  model: 'Mac Mini 2014',
  description: "We offer a comprehensive set of repairs for the Mac Mini 2014. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the Mac Mini 2014. Including screen replacements, batteries and much more.",
  imageSrc: '/mac/devices/mac-mini-14.jpg',
  imageAlt: 'Image of an Mac Mini 2014.',
  imageAlt2: 'Image of the rear of an Mac Mini 2014.',
  breadcrumbs: [
    { id: 1, name: 'Mac Repairs', href: '/mac-repairs' },
    { id: 2, name: 'Mac Mini Repairs', href: '../mac-mini-repairs' },
    { id: 3, name: 'Mac Mini 2014', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/mac-repairs/mac-mini/mac-mini-2014-repairs" />
