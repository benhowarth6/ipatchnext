...
const product = {
  name: 'iPod Nano 6th Generation Repairs',
  device_model: 'Nano 6th Generation',
  description: "We offer a comprehensive set of repairs for the iPod Nano 6. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPod Nano 6. Including screen replacements, batteries and much more.",
  imageSrc: '/ipod/devices/ipod-nano-6.jpg',
  imageAlt: 'Image of an iPod Nano 6.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipod-repairs' },
    { id: 2, name: 'iPod Nano Repairs', href: '../ipod-nano-repairs' },
    { id: 3, name: 'iPod Nano 6', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipod-repairs/ipod-nano/ipod-nano-6-repairs/" />
