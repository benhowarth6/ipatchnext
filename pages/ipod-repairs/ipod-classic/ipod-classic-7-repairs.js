...
const product = {
  name: 'iPod Classic 7th Generation Repairs',
  device_model: 'Classic 7th Generation',
  description: "We offer a comprehensive set of repairs for the iPod Classic 7. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPod Classic 7. Including screen replacements, batteries and much more.",
  imageSrc: '/ipod/devices/ipod-classic-7.jpg',
  imageAlt: 'Image of an iPod Classic 7.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipod-repairs' },
    { id: 2, name: 'iPod Classic Repairs', href: '../ipod-classic-repairs' },
    { id: 3, name: 'iPod Classic 7', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipod-repairs/ipod-classic/ipod-classic-7-repairs/" />
