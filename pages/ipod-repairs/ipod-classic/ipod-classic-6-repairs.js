...
import Details from "../../../components/ipod-repair/Details";
import Incentives from "../../../components/ipod-repair/Incentives";
import Footer from "../../../components/Footer";

import repairs from "../../../data/ipod/ipod-repairs.json";

const product = {
  name: 'iPod Classic 6th Generation Repairs',
  device_model: 'Classic 6th Generation',
  description: "We offer a comprehensive set of repairs for the iPod Classic 6. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPod Classic 6. Including screen replacements, batteries and much more.",
  imageSrc: '/ipod/devices/ipod-classic-6.jpg',
  imageAlt: 'Image of an iPod Classic 6.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipod-repairs' },
    { id: 2, name: 'iPod Classic Repairs', href: '../ipod-classic-repairs' },
    { id: 3, name: 'iPod Classic 6', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipod-repairs/ipod-classic/ipod-classic-6-repairs/" />
