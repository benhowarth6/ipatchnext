...
const product = {
  name: 'iPod Touch 7th Generation Repairs',
  device_model: 'Touch 7th Generation',
  description: "We offer a comprehensive set of repairs for the iPod Touch 7. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPod Touch 7. Including screen replacements, batteries and much more.",
  imageSrc: '/ipod/devices/ipod-touch-7.jpg',
  imageAlt: 'Image of an iPod Touch 7.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipod-repairs' },
    { id: 2, name: 'iPod Touch Repairs', href: '../ipod-touch-repairs' },
    { id: 3, name: 'iPod Touch 7', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipod-repairs/ipod-touch/ipod-touch-7-repairs/" />
