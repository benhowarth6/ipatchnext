...
const product = {
  name: 'iPod Touch 5th Generation Repairs',
  device_model: 'Touch 5th Generation',
  description: "We offer a comprehensive set of repairs for the iPod Touch 5. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPod Touch 5. Including screen replacements, batteries and much more.",
  imageSrc: '/ipod/devices/ipod-touch-5.jpg',
  imageAlt: 'Image of an iPod Touch 5.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipod-repairs' },
    { id: 2, name: 'iPod Touch Repairs', href: '../ipod-touch-repairs' },
    { id: 3, name: 'iPod Touch 5', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipod-repairs/ipod-touch/ipod-touch-5-repairs/" />
