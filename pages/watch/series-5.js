...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="Apple Watch Series 5 Screen Replacement & Battery Repairs in Leeds - iPatch"
        description="We repair Apple Watch Series 5 screens and batteries. We aim to complete all repairs in the same day and include a 90 day warranty."
      />
      <Header />
