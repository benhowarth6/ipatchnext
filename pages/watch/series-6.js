          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-4 text-xl text-gray-600">
                We offer a comprehensive set of repairs for the Apple Watch Series 6.
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
            ...
            <div className="mt-10 max-w-lg mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-start-3 lg:col-end-6 lg:row-start-1 lg:row-end-4">
              <div className="relative z-10 rounded-lg shadow-xl">
                <div className="pointer-events-none absolute inset-0 rounded-lg border-2 border-blue-600" aria-hidden="true"></div>
          ...
          <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div className="relative">
              ...
              <p className="mt-3 text-lg text-gray-500">
                Your iPad display includes a number of important features, such
                as True-Tone and Apple Pencil support.
              </p>
              ...
              <dl className="mt-10 space-y-10">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <dd className="mt-2 text-base text-gray-500">
                      ...
                      possible, this ensures your iPad works as expected after
                      any repairs and no loss of functionality such as Apple
                      Pencil.
                    </dd>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <dd className="mt-2 text-base text-gray-500">
                      ...
                      advanced sealing process. Should your iPad require any
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <dd className="mt-2 text-base text-gray-500">
                      We offer same day turnaround on the majority of our iPad
