...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="Apple Watch Series 6 Repairs in Leeds | Screen Replacements, Batteries and more"
        description="Expert Apple Watch Series 6 repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our Apple Watch Series 6 repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/watch/series-6"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/watch/series-6',
          title: 'Apple Watch Series 6 Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert Apple Watch Series 6 repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our Apple Watch Series 6 repairs include a 3 month warranty.',
          images: [
            {
              ...
              width: 1200,
              height: 630,
              alt: "iPatch | Apple Watch Series 6 Repairs in Leeds"
            }
          ]
        }}
      />
