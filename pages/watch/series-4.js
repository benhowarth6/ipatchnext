...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="Apple Watch Series 4 Repairs in Leeds | Screen Replacements, Batteries and more"
        description="Expert Apple Watch Series 4 repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our Apple Watch Series 4 repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/watch/series-4"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/watch/series-4',
          title: 'Apple Watch Series 4 Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert Apple Watch Series 4 repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our Apple Watch Series 4 repairs include a 3 month warranty.',
          images: [
            {
              ...
              width: 1200,
              height: 630,
              alt: "iPatch | Apple Watch Series 4 Repairs in Leeds"
            }
          ]
        }}
      />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h2 className="mt-4 text-xl text-gray-600">
                ...
                Series 4. Including screen replacements, batteries and much
                more.
              </h2>
            </div>
          </div>
                          ...
                          <div className="rounded-lg shadow-md">
                            <Link
                              href={{
                                ...
                                query: { model: "Series 4", repair: "battery" },
                              }}
                            >
                              <a
                    ...
                    <div className="border-t-2 border-gray-100 rounded-b-lg pt-10 pb-8 px-6 bg-gray-50 sm:px-10 sm:py-10">
                      ...
                      <div className="mt-10">
                        ...
                        <Link
                              href={{
                                pathname: "book-repair/booking-type",
                                query: { model: "Series 4", repair: "40mm-screen" },
                              }}
                            >
                          <a
                      ...
                      <div className="flex-1 flex flex-col justify-between border-t-2 border-gray-100 p-6 bg-gray-50 sm:p-10 lg:p-6 xl:p-10">
                        ...
                        <div className="mt-8">
                          ...
                          <Link
                              href={{
                                pathname: "book-repair/booking-type",
                                query: { model: "Series 4", repair: "44mm-screen" },
                              }}
                            >
                            <a
                              className="block w-full text-center rounded-lg border border-transparent bg-white px-6 py-3 text-base font-medium text-blue-600 hover:bg-gray-50"
                ...
                <div className="bg-gray-100 rounded-lg shadow-sm divide-y divide-gray-200">
                  <div className="p-6">
                    ...
                    <Link
                      href={{
                        pathname: "book-repair/booking-type",
                        query: { model: "Series 4", repair: "not-sure" },
                      }}
                    >
                ...
                <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-sm divide-y divide-gray-200">
                  <div className="p-6">
                    ...
                    <Link
                      href={{
                        pathname: "book-repair/booking-type",
                        query: { model: "Series 4", repair: "liquid-damage" },
                      }}
                    >
                      <a className="mt-8 flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-white hover:bg-gray-50">
                        Book an Inspection
