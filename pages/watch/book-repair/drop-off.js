...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="Book a Drop-Off Apple Watch Repair in Leeds - iPatch"
        description="Book your Apple Watch in with us for a drop-off repair at one of our Leeds stores using this form."
      />
      <Header />
