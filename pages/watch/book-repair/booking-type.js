...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="Choose Your Apple Watch Repair Booking Type - iPatch"
        description="Choose how you'd like to get your Apple Watch repaired, we accept both mail in and drop off repairs."
      />
      <Navigation />
