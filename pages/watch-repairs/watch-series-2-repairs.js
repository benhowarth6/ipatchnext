...
const product = {
  ...
  imageAlt: 'Image of an Apple Watch Series 2.',
  breadcrumbs: [
    { id: 1, name: 'Watch Repairs', href: '/watch-repairs' },
    { id: 2, name: 'Apple Watch Series 2', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/watch-repairs/watch-series-2-repairs/" />
