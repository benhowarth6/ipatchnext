...
const product = {
  name: 'Apple Watch Series 6 Repairs',
  device_model: 'Series 6',
  description: "We offer a comprehensive set of repairs for the Apple Watch Series 6. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the Apple Watch Series 6. Including screen replacements, batteries and much more.",
  imageSrc: '/watch/devices/series-6.jpg',
  imageAlt: 'Image of an Apple Watch Series 6.',
  breadcrumbs: [
    { id: 1, name: 'Watch Repairs', href: '/watch-repairs' },
    { id: 2, name: 'Apple Watch Series 6', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/watch-repairs/watch-series-6-repairs/" />
