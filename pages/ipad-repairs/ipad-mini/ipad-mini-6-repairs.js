...
const product = {
  name: 'iPad Mini 6 Repairs',
  device_model: 'Mini 6',
  description: "We offer a comprehensive set of repairs for the iPad Mini 6. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPad Mini 6. Including screen replacements, batteries and much more.",
  imageSrc: '/ipad/devices/ipad-mini-6.jpg',
  imageAlt: 'Image of an iPad Mini 6.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipad-repairs' },
    { id: 2, name: 'iPad Mini Repairs', href: '../ipad-mini-repairs' },
    { id: 3, name: 'iPad Mini 6', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipad-repairs/ipad-mini/ipad-mini-6-repairs/" />
                ...
                <div class="flex">
                  ...
                  <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700">
                      <p>
                        We have limited part availability for this device,&nbsp;
                        <Link href="/././contact-us">
                          <a class="font-medium underline text-yellow-700 hover:text-yellow-600">
