...
const product = {
  name: 'iPad Mini 1 Repairs',
  model: 'iPad Mini 1',
  description: "We offer a comprehensive set of repairs for the iPad Mini 1. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPad Mini 1. Including screen replacements, batteries and much more.",
  imageSrc: '/ipad/devices/ipad-mini-1.jpg',
  imageAlt: 'Image of an iPad Mini 1.',
  imageAlt1: 'Image of the rear of an iPad Mini 1.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipad-repairs' },
    { id: 1, name: 'iPad Mini Repairs', href: '../ipad-mini-repairs' },
    { id: 1, name: 'iPad Mini 1', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipad-repairs/ipad-mini/ipad-mini-1-repairs/" />
