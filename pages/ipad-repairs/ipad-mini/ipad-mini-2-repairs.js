...
const product = {
  name: 'iPad Mini 2 Repairs',
  model: 'iPad Mini 2',
  description: "We offer a comprehensive set of repairs for the iPad Mini 2. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPad Mini 2. Including screen replacements, batteries and much more.",
  imageSrc: '/ipad/devices/ipad-mini-2.jpg',
  imageAlt: 'Image of an iPad Mini 2.',
  imageAlt2: 'Image of the rear of an iPad Mini 2.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipad-repairs' },
    { id: 2, name: 'iPad Mini Repairs', href: '../ipad-mini-repairs' },
    { id: 2, name: 'iPad Mini 2', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipad-repairs/ipad-mini/ipad-mini-2-repairs/" />
