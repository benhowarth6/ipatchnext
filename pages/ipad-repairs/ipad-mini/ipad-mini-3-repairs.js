...
const product = {
  name: 'iPad Mini 3 Repairs',
  model: 'iPad Mini 3',
  description: "We offer a comprehensive set of repairs for the iPad Mini 3. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPad Mini 3. Including screen replacements, batteries and much more.",
  imageSrc: '/ipad/devices/ipad-mini-3.jpg',
  imageAlt: 'Image of an iPad Mini 3.',
  imageAlt2: 'Image of the rear of an iPad Mini 3.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipad-repairs' },
    { id: 2, name: 'iPad Mini Repairs', href: '../ipad-mini-repairs' },
    { id: 3, name: 'iPad Mini 3', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipad-repairs/ipad-mini/ipad-mini-3-repairs/" />
