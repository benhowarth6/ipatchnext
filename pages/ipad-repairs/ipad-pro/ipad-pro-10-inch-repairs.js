...
const product = {
  name: 'iPad Pro 10.5-inch Repairs',
  device_model: 'Pro 10.5-inch',
  description: "We offer a comprehensive set of repairs for the iPad Pro 10.5-inch. Including screen replacements, batteries and much more.",
  ...
  breadcrumbs: [
    ...
    { id: 3, name: 'iPad Pro 10.5-inch', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipad-repairs/ipad-pro/ipad-pro-10-repairs/" />
