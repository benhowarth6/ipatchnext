...
const product = {
  ...
  imageAlt: 'Image of an iPad Pro 12.9-inch 3rd Generation.',
  imageAlt2: 'Image of the rear of an iPad Pro 12.9-inch 3rd Generation.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipad-repairs' },
    { id: 2, name: 'iPad Pro Repairs', href: '../ipad-pro-repairs' },
    { id: 3, name: 'iPad Pro 12.9-inch 3rd Generation', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipad-repairs/ipad-pro/ipad-pro-12-inch-3-repairs/" />
