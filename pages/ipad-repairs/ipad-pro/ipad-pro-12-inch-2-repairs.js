...
const product = {
  name: 'iPad Pro 12.9-inch 2nd Generation Repairs',
  model: 'iPad Pro 12.9-inch 2nd Generation',
  description: "We offer a comprehensive set of repairs for the iPad Pro 12.9-inch 2nd Generation. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPad Pro 12.9-inch 2nd Generation. Including screen replacements, batteries and much more.",
  imageSrc: '/ipad/devices/ipad-pro-12-2.jpg',
  imageAlt: 'Image of an iPad Pro 12.9-inch 2nd Generation.',
  imageAlt2: 'Image of the rear of an iPad Pro 12.9-inch 2nd Generation.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipad-repairs' },
    { id: 2, name: 'iPad Pro Repairs', href: '../ipad-pro-repairs' },
    { id: 3, name: 'iPad Pro 12.9-inch 2nd Generation', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipad-repairs/ipad-pro/ipad-pro-12-inch-2-repairs/" />
