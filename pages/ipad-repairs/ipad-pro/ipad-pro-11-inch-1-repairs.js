...
const product = {
  name: 'iPad Pro 11-inch 1st Generation Repairs',
  model: 'iPad Pro 11-inch 1st Generation',
  description: "We offer a comprehensive set of repairs for the iPad Pro 11-inch 1st Generation. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPad Pro 11-inch 1st Generation. Including screen replacements, batteries and much more.",
  imageSrc: '/ipad/devices/ipad-pro-11-1.jpg',
  imageAlt: 'Image of an iPad Pro 11-inch 1st Generation.',
  imageAlt2: 'Image of the rear of an iPad Pro 11-inch 1st Generation.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipad-repairs' },
    { id: 2, name: 'iPad Pro Repairs', href: '../ipad-pro-repairs' },
    { id: 3, name: 'iPad Pro 11-inch 1st Generation', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipad-repairs/ipad-pro/ipad-pro-11-inch-1-repairs/" />
