...
const product = {
  name: 'iPad Air 3 Repairs',
  model: 'iPad Air 3',
  description: "We offer a comprehensive set of repairs for the iPad Air 3. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPad Air 3. Including screen replacements, batteries and much more.",
  imageSrc: '/ipad/devices/ipad-air-3.jpg',
  imageAlt: 'Image of an iPad Air 3.',
  imageAlt2: 'Image of the rear of an iPad Air 3.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipad-repairs' },
    { id: 2, name: 'iPad Air Repairs', href: '../ipad-air-repairs' },
    { id: 3, name: 'iPad Air 3', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipad-repairs/ipad-air/ipad-air-3-repairs/" />
