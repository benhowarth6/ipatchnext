...
const product = {
  name: 'iPad Air 2 Repairs',
  device_model: 'Air 2',
  description: "We offer a comprehensive set of repairs for the iPad Air 2. Including screen replacements, batteries and much more.",
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipad-repairs/ipad-air/ipad-air-2-repairs/" />
