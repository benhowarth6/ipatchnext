...
const product = {
  name: 'iPad 4th Generation Repairs',
  model: 'iPad 4th Generation',
  description: "We offer a comprehensive set of repairs for the iPad 4th Generation. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPad 4th Generation. Including screen replacements, batteries and much more.",
  imageSrc: '/ipad/devices/ipad-4.jpg',
  imageAlt: 'Image of an iPad 4th Generation.',
  imageAlt2: 'Image of the rear of an iPad 4th Generation.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipad-repairs' },
    { id: 2, name: 'iPad Repairs', href: '../ipad-repairs' },
    { id: 3, name: 'iPad 4th Generation', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipad-repairs/ipad/ipad-4-repairs/" />
