...
const product = {
  name: 'iPad 3rd Generation Repairs',
  model: 'iPad 3rd Generation',
  description: "We offer a comprehensive set of repairs for the iPad 3rd Generation. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPad 3rd Generation. Including screen replacements, batteries and much more.",
  imageSrc: '/ipad/devices/ipad-3.jpg',
  imageAlt: 'Image of an iPad 3rd Generation.',
  imageAlt2: 'Image of the rear of an iPad 3rd Generation.',
  breadcrumbs: [
    { id: 1, name: 'iPad Repairs', href: '/ipad-repairs' },
    { id: 2, name: 'iPad Repairs', href: '../ipad-repairs' },
    { id: 3, name: 'iPad 3rd Generation', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipad-repairs/ipad/ipad-3-repairs/" />
