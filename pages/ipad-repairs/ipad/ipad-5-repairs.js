...
const product = {
  name: 'iPad 5th Generation Repairs',
  device_model: '5th Generation',
  description: "We offer a comprehensive set of repairs for the iPad 5th Generation. Including screen replacements, batteries and much more.",
  ...
  breadcrumbs: [
    ...
    { id: 3, name: 'iPad 5th Generation', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/ipad-repairs/ipad/ipad-5-repairs/" />
