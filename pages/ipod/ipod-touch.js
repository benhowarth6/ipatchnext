...
export default function Home() {
  return (
    <div>
      <NextSeo
        title="iPod Touch Repairs in Leeds | Screen Replacements, Batteries and more"
        description="Expert Apple iPod Touch repairs in Trinity Leeds. We offer replacement screens, batteries, headphone jacks and more while you wait. All of our iPod Touch repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/ipod/ipod-touch"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/ipod/ipod-touch',
          title: 'iPod Touch Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert Apple iPod Touch repairs in Trinity Leeds. We offer replacement screens, batteries, headphone jacks and more while you wait. All of our iPod Touch repairs include a 3 month warranty.',
          images: [
            {
              ...
              width: 1200,
              height: 630,
              alt: "iPatch | iPod Touch Repairs in Leeds"
            }
          ]
        }}
      />
      ...
      <div className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="mt-1 text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl">iPod Touch Repairs</h1>
            <h2 className="max-w-2xl mt-5 mx-auto text-xl text-white">We offer a large selection of iPod Touch repairs including screens, batteries, headphone jacks and more for nearly all models. </h2>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 pt-16 pb-20 lg:pt-24 lg:pb-28 lg:px-8 md:hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center">
            <h2 className="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl">
              Select your iPod Touch Model
            </h2>
            <p className="py-4 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
              Click on your iPod Touch below to view repairs.
            </p>
          </div>
        </div>
     ...
     <div className="bg-white">
        <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
          <h2 className="text-3xl font-extrabold text-gray-800 tracking-tight">Everything needed for a great iPod Touch repair</h2>
