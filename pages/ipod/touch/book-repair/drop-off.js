...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="Book a Drop-Off iPod Touch Repair in Leeds - iPatch"
        description="Book your iPod Touch in with us for a drop-off repair at one of our Leeds stores using this form."
      />
      <Navigation />
      ...
      <div className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="mt-1 text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl">Drop-off iPod Touch Repair</p>
            <p className="max-w-2xl mt-5 mx-auto text-xl text-white">Use this form to book your iPod Touch in with us for a drop-off repair.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-100">
        <div className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:pb-14 lg:px-8">
          <form
            className="kwes-form"
            action="https://kwes.io/api/foreign/forms/zGTEYTDwSEx8bSu3KMJ7"
            redirect="success"
          >
