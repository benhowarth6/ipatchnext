...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="Choose Your iPod Touch Repair Booking Type - iPatch"
        description="Choose how you'd like to get your iPod Touch repaired, we accept both mail in and drop off repairs."
      />
      <Header />
