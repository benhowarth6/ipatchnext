...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="Book a Mail-In iPod Nano Repair - iPatch"
        description="Book your iPod Nano in with us for a mail-in repair to post your device to us from anywhere in the world."
      />
      <Navigation />
      ...
      <div className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="mt-1 text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl">Mail-in iPod Nano Repair</p>
            <p className="max-w-2xl mt-5 mx-auto text-xl text-white">Use this form to book your iPod Nano in with us for a mail-in repair.</p>
          </div>
        </div>
      </div>
