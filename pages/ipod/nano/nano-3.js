...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="iPod Nano 3rd Generation Repairs in Leeds | Screen Replacements, Batteries and more"
        description="Expert Apple iPod Nano 3rd Generation repairs in Trinity Leeds. We offer replacement screens, batteries, headphone jacks and more while you wait. All of our iPod Nano 3rd Generation repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/ipod/nano/nano-3"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/ipod/nano/nano-3',
          title: 'iPod Nano 3rd Generation Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert Apple iPod Nano 3rd Generation repairs in Trinity Leeds. We offer replacement screens, batteries, headphone jacks and more while you wait. All of our iPod Nano 3rd Generation repairs include a 3 month warranty.',
          images: [
            {
              ...
              width: 1200,
              height: 630,
              alt: "iPatch | iPod Nano 3rd Generation Repairs in Leeds"
            }
          ]
        }}
      />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-3xl font-extrabold text-gray-900 sm:text-4xl lg:text-5xl">
                iPod Nano 3rd Generation Repair
              </h1>
              <h2 className="mt-4 text-xl text-gray-600">
                We offer a comprehensive set of repairs for the third generation 
                  ...
                  <div className="mt-6">
                    ...
                    <Link
                        href={{
                          ...
                          query: { model: "Nano 3", repair: "glass" },
                        }}
                      >
        ...
        <div className="max-w-7xl mx-auto pb-24 px-4 sm:px-6 lg:px-8">
          <div className="sm:flex sm:flex-col sm:align-center">
            ...
            <p className="mt-4 text-xl text-gray-600 sm:text-center">
              Here's all the repairs we offer for iPod Nano 3rd Generation.
            </p>
          </div>
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "Nano 3", repair: "battery" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="bg-gray-100 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "Nano 3", repair: "not-sure" },
                  }}
                >
            ...
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "Nano 3", repair: "liquid-damage" },
                  }}
                >
                  <a className="mt-8 flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-white hover:bg-gray-50">
                    Book an Inspection
      ...
      <div className="py-16 bg-gray-100 overflow-hidden lg:py-24">
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
          <div className="relative">
            ...
            <p className="mt-4 text-xl text-gray-600 sm:text-center">
              Why repair your iPod Nano 3rd Generation with iPatch?
            </p>
          </div>
