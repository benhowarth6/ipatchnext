...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="iPod Nano 2nd Generation Screen Replacement & Other Repairs in Leeds - iPatch"
        description="We repair iPod Nano 2nd Generation screens, batteries, headphone jacks and more. We aim to complete all repairs in the same day and include a 90 day warranty."
      />
      <Header />
