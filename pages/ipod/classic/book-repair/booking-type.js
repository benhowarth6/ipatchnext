...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="Choose Your iPod Classic Repair Booking Type - iPatch"
        description="Choose how you'd like to get your iPod Classic repaired, we accept both mail in and drop off repairs."
      />
      <Navigation />
