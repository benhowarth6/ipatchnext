...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="iPod Classic 6th Generation Hard Drive Replacement & Other Repairs in Leeds - iPatch"
        description="We repair iPod Classic 6th Generation hard drives, batteries, headphone jacks and more. We aim to complete all repairs in the same day and include a 90 day warranty."
      />
      <Header />
