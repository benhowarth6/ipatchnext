...
const links = [
  { title: 'iPhone Repairs', href:'/iphone-repairs', description: 'Find and view the repairs we offer on all models of iPhone', icon: BookOpenIcon },
  { title: 'iPad Repairs', href:'/ipad-repairs', description: 'Find and view the repairs we offer on all models of iPad', icon: ViewListIcon },
  { title: 'Mac Repairs', href:'/mac-repairs', description: 'Find and view the repairs we offer on various Mac\'s', icon: BookmarkAltIcon },
  { title: 'Contact', href:'/contact', description: 'Find out how you can get in touch with us', icon: RssIcon },
]
const social = [
  {
    name: 'Facebook',
    ...
    <div className="bg-white">
      ...
      <footer className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="border-t border-gray-200 py-12 text-center md:flex md:justify-between">
          <p className="text-base text-gray-400">&copy; iPatch, Inc. All rights reserved.</p>
          <div className="mt-6 flex justify-center space-x-8 md:mt-0">
            {social.map((item, itemIdx) => (
              <a key={itemIdx} href={item.href} target="_blank" className="inline-flex text-gray-400 hover:text-gray-500">
