...
import Incentive from "../components/watch/Incentive";
import About from "../components/watch/About";
import AboutFurther from "../components/watch/About-Further";
import Parts from "../components/watch/Parts";

import models from '../data/watch/watch-models.json';
      ...
      <div className="bg-white">
        <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <div className="mt-6 grid grid-cols-2 gap-x-8 gap-y-8 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            {models.map(watchModel => {
              const { id, name, image, alt, href } = watchModel;
              return (
            ...
            <dl className="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:gap-y-10">
              <div>
                ...
                <dd className="mt-2 text-sm text-gray-500">
                  ...
                  services. If you aren’t sure which repair your Watch
              ...
              <div>
                ...
                <dd className="mt-2 text-sm text-gray-500">
                  ...
                  and the model of Watch. We list nearly all repair costs for
              ...
              <div>
                ...
                <dd className="mt-2 text-sm text-gray-500">
                  We understand how important Watch's have become, so we aim to
                  complete all repairs in the same day, usually the same hour.
                  A drop off repair for your Watch is the quickest way to get
                  your device repaired, and we usually complete nearly all
                  Watch repairs in a couple of hours. Should you want to mail in
              ...
              <div>
                ...
                <dd className="mt-2 text-sm text-gray-500">
                  We offer a wide range of repairs for all Watch models,
                  however should a repair not be possible on your device you
                  can collect your Watch with no fee or just the return postage
              ...
              <div>
                ...
                <dd className="mt-2 text-sm text-gray-500">
                  Watch screen replacements are our most common repair, we can
          ...
          <div className="relative">
            <blockquote className="mt-10">
              <div className="max-w-3xl mx-auto text-center text-2xl leading-9 font-medium text-gray-900">
                <p>
                  “Fantastic service from iPatch who repaired my Watch’s screen
                  and then some. The repair was completed swiftly and my Watch is
                  as good as new.”
                </p>
                <p className="mt-4">
