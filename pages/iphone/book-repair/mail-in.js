    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-600">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="mt-1 text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl">Mail-in iPhone Repair</p>
            <p className="max-w-2xl mt-5 mx-auto text-xl text-white">Use this form to book your iPhone in with us for a mail-in repair.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-100">
        <div className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:pb-14 lg:px-8">
          <form
            className="kwes-form"
            action="https://kwes.io/api/foreign/forms/PKLlUzAY3asSfqYig1be"
            redirect="success"
          >
