...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="iPhone 12 Pro Max Screen Replacement & Other Repairs in Leeds - iPatch"
        description="We repair iPhone 12 Pro Max screens, batteries, charging ports and more. We aim to complete all repairs in the same day and include a 90 day warranty."
      />
      <Header />
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto pb-24 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-24 space-y-4 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 xl:grid-cols-4">
