...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="iPhone 5C Repairs in Leeds | Screen Replacements, Batteries and more"
        description="Expert Apple iPhone 5C repairs in Trinity Leeds. We offer replacement screens, batteries, liquid damage services and more while you wait. All of our iPhone 5C repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/iphone/5c"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/iphone/5c',
          title: 'iPhone 5C Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert Apple iPhone 5C repairs in Trinity Leeds. We offer replacement screens, batteries, liquid damage services and more while you wait. All our iPhone 5C repairs include a 3 month warranty.',
          images: [
            {
              url: "https://www.ipatchrepairs.co.uk/iphone-social.jpg",
              width: 1200,
              height: 630,
              alt: "iPatch | iPhone 5C Repairs in Leeds"
            }
          ]
        }}
      />
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "5C", repair: "front-camera" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
