...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="iPhone 5S Screen Replacement & Other Repairs in Leeds - iPatch"
        description="We repair iPhone 5S screens, batteries, charging ports and more. We aim to complete all repairs in the same day and include a 90 day warranty."
      />
      <Header />
