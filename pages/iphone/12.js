...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="iPhone 12 Repairs in Leeds | Screen Replacements, Batteries and more"
        description="Expert Apple iPhone 12 repairs in Trinity Leeds. We offer replacement screens, batteries, liquid damage services and more while you wait. All of our iPhone 12 repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/iphone/12"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/iphone/12',
          title: 'iPhone 12 Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert Apple iPhone 12 repairs in Trinity Leeds. We offer replacement screens, batteries, liquid damage services and more while you wait. All our iPhone 12 repairs include a 3 month warranty.',
          images: [
            {
              url: "https://www.ipatchrepairs.co.uk/iphone-social.jpg",
              width: 1200,
              height: 630,
              alt: "iPatch | iPhone 12 Repairs in Leeds"
            }
          ]
        }}
      />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h2 className="mt-4 text-xl text-gray-600">
                We offer a comprehensive set of repairs for the iPhone 12.
        ...
        <div className="max-w-7xl mx-auto pb-24 px-4 sm:px-6 lg:px-8">
          <div className="sm:flex sm:flex-col sm:align-center">
            ...
            <p className="mt-4 text-xl text-gray-600 sm:text-center">
              Here's all the repairs we offer for iPhone 12.
            </p>
          </div>
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "12", repair: "rear-case" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "12", repair: "charging-port" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "12", repair: "rear-camera" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "12", repair: "camera-lens" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "12", repair: "earpiece" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "12", repair: "loudspeaker" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "12", repair: "button-fault" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="bg-gray-100 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "12", repair: "not-sure" },
                  }}
                >
            ...
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "12", repair: "liquid-damage" },
                  }}
                >
                  <a className="mt-8 flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-white hover:bg-gray-50">
                    Book an Inspection
      ...
      <div className="py-16 bg-gray-100 overflow-hidden lg:py-24">
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
          <div className="relative">
            ...
            <p className="mt-4 text-xl text-gray-600 sm:text-center">
              Why repair your iPhone 12 with iPatch?
            </p>
          </div>
