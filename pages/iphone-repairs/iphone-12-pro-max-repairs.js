...
const product = {
  ...
  device_model: '12 Pro Max',
  description: "We offer a comprehensive set of repairs for the iPhone 12 Pro Max. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 12 Pro Max. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/12-pro-max.jpg',
  imageSrc2: '/iphone/devices/12-pro-max-rear.jpg',
  imageAlt: 'Image of an iPhone 12 Pro Max.',
  imageAlt2: 'Image of the rear of an iPhone 12 Pro Max.',
  breadcrumbs: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-12-pro-max-repairs/" />
