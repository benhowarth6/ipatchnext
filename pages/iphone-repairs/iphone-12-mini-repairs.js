...
const product = {
  ...
  imageSrc2: '/iphone/devices/12-mini-rear.jpg',
  imageAlt: 'Image of an iPhone 12 Mini.',
  imageAlt2: 'Image of the rear of an iPhone 12 Mini.',
  breadcrumbs: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-12-mini-repairs/" />
