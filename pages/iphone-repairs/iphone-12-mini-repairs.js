...
const product = {
  ...
  sizes: [
    { id: 1, name: 'Display Assembly', description: 'A new OLED display assembly to repair a damaged screen.', price: '£299', pathname: '../iphone/book-repair/booking-type', query: 'model=12+Mini&repair=screen' },
    { id: 2, name: 'Battery', description: 'A new battery to restore your device to 100%.', price: '£85', pathname: '../iphone/book-repair/booking-type', query: 'model=12+Mini&repair=battery' },
    { id: 3, name: 'Rear Housing', description: 'A new housing and frame to replace a cracked back.', price: '£399', pathname: '../iphone/book-repair/booking-type', query: 'model=12+Mini&repair=rear-case' },
    { id: 4, name: 'Charging Port', description: 'A new charging port to restore device charging.', price: '£85', pathname: '../iphone/book-repair/booking-type', query: 'model=12+Mini&repair=charging-port' },
    { id: 5, name: 'Microphone', description: 'A new Microphone to restore sound pickup.', price: '£85', pathname: '../iphone/book-repair/booking-type', query: 'model=12+Mini&repair=microphone' },
    { id: 6, name: 'Rear Camera Lens', description: 'A new replacement camera lens if one of yours is damaged.', price: '£85', pathname: '../iphone/book-repair/booking-type', query: 'model=12+Mini&repair=camera-lens' },
    { id: 7, name: 'Earpiece Speaker', description: 'A replacement speaker if you cannot hear on phone calls.', price: '£85', pathname: '../iphone/book-repair/booking-type', query: 'model=12+Mini&repair=earpiece' },
    { id: 8, name: 'Loudspeaker', description: 'A replacement loudspeaker if you cannot hear any audio.', price: '£85', pathname: '../iphone/book-repair/booking-type', query: 'model=12+Mini&repair=loudspeaker' },
    { id: 9, name: 'Button Fault', description: 'A replacement button flex if one of yours isn\'t working.', price: '£85', pathname: '../iphone/book-repair/booking-type', query: 'model=12+Mini&repair=button-fault' },
  ],
  highlights: [
