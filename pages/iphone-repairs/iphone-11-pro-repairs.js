...
const product = {
  name: 'iPhone 11 Pro Repairs',
  model: 'iPhone 11 Pro',
  description: "We offer a comprehensive set of repairs for the iPhone 11 Pro. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 11 Pro. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/11-pro.jpg',
  imageSrc2: '/iphone/devices/11-pro-rear.jpg',
  imageAlt: 'Image of an iPhone 11 Pro.',
  imageAlt2: 'Image of the rear of an iPhone 11 Pro.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 11 Pro', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-11-pro-repairs/" />
