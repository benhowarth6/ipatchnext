...
const product = {
  name: 'iPhone 7 Plus Repairs',
  device_model: '7 Plus',
  description: "We offer a comprehensive set of repairs for the iPhone 7 Plus. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 7 Plus. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/7-plus.jpg',
  imageSrc2: '/iphone/devices/7-plus-rear.jpg',
  imageAlt: 'Image of an iPhone 7 Plus.',
  imageAlt2: 'Image of the rear of an iPhone 7 Plus.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 7 Plus', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-7-plus-repairs/" />
