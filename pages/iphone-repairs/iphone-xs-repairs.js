...
const product = {
  ...
  model: 'iPhone XS',
  description: "We offer a comprehensive set of repairs for the iPhone XS. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone XS. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/xs.jpg',
  imageSrc2: '/iphone/devices/xs-rear.jpg',
  imageAlt: 'Image of an iPhone XS.',
  imageAlt2: 'Image of the rear of an iPhone XS.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone XS', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-xs-repairs/" />
