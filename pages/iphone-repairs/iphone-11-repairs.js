...
const product = {
  ...
  model: 'iPhone 11',
  description: "We offer a comprehensive set of repairs for the iPhone 11. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 11. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/11.jpg',
  imageSrc2: '/iphone/devices/11-rear.jpg',
  imageAlt: 'Image of an iPhone 11.',
  imageAlt2: 'Image of the rear of an iPhone 11.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 11', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-11-repairs/" />
