...
const product = {
  name: 'iPhone SE 2020 Repairs',
  device_model: 'SE 2020',
  description: "We offer a comprehensive set of repairs for the iPhone SE 2020. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone SE 2020. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/se-2.jpg',
  imageSrc2: '/iphone/devices/se-2-rear.jpg',
  imageAlt: 'Image of an iPhone SE 2020.',
  imageAlt2: 'Image of the rear of an iPhone SE 2020.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone SE 2020', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-se-2020-repairs/" />
