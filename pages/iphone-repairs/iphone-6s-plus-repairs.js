...
const product = {
  ...
  device_model: '6S Plus',
  description: "We offer a comprehensive set of repairs for the iPhone 6S Plus. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 6S Plus. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/6s-plus.jpg',
  imageSrc2: '/iphone/devices/6s-plus-rear.jpg',
  imageAlt: 'Image of an iPhone 6S Plus.',
  imageAlt2: 'Image of the rear of an iPhone 6S Plus.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 6S Plus', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-6s-plus-repairs/" />
