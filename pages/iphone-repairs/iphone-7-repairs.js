...
const product = {
  name: 'iPhone 7 Repairs',
  model: 'iPhone 7',
  description: "We offer a comprehensive set of repairs for the iPhone 7. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 7. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/7.jpg',
  imageSrc2: '/iphone/devices/7-rear.jpg',
  imageAlt: 'Image of an iPhone 7.',
  imageAlt2: 'Image of the rear of an iPhone 7.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 7', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-7-repairs/" />
