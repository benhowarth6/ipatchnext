...
const product = {
  name: 'iPhone 6 Plus Repairs',
  device_model: '6 Plus',
  description: "We offer a comprehensive set of repairs for the iPhone 6 Plus. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 6 Plus. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/6-plus.jpg',
  imageSrc2: '/iphone/devices/6-plus-rear.jpg',
  imageAlt: 'Image of an iPhone 6 Plus.',
  imageAlt2: 'Image of the rear of an iPhone 6 Plus.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 6 Plus', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-6-plus-repairs/" />
