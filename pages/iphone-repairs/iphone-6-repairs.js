...
const product = {
  name: 'iPhone 6 Repairs',
  model: 'iPhone 6',
  description: "We offer a comprehensive set of repairs for the iPhone 6. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 6. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/6.jpg',
  imageSrc2: '/iphone/devices/6-rear.jpg',
  imageAlt: 'Image of an iPhone 6.',
  imageAlt2: 'Image of the rear of an iPhone 6.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 6', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-6-repairs/" />
