...
const product = {
  name: 'iPhone 8 Repairs',
  model: 'iPhone 8',
  description: "We offer a comprehensive set of repairs for the iPhone 8. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 8. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/8.jpg',
  imageSrc2: '/iphone/devices/8-rear.jpg',
  imageAlt: 'Image of an iPhone 8.',
  imageAlt2: 'Image of the rear of an iPhone 8.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 8', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-8-repairs/" />
