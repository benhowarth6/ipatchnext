...
const product = {
  name: 'iPhone 6S Repairs',
  model: 'iPhone 6S',
  description: "We offer a comprehensive set of repairs for the iPhone 6S. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 6S. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/6s.jpg',
  imageSrc2: '/iphone/devices/6s-rear.jpg',
  imageAlt: 'Image of an iPhone 6S.',
  imageAlt2: 'Image of the rear of an iPhone 6S.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 6S', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-6s-repairs/" />
