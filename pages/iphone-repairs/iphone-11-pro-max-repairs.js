...
const product = {
  name: 'iPhone 11 Pro Max Repairs',
  device_model: '11 Pro Max',
  description: "We offer a comprehensive set of repairs for the iPhone 11 Pro Max. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 11 Pro Max. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/11-pro-max.jpg',
  imageSrc2: '/iphone/devices/11-pro-max-rear.jpg',
  imageAlt: 'Image of an iPhone 11 Pro Max.',
  imageAlt2: 'Image of the rear of an iPhone 11 Pro Max.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 11 Pro Max', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-11-plus-repairs/" />
