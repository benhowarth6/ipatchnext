...
const product = {
  name: 'iPhone 5 Repairs',
  model: 'iPhone 5',
  description: "We offer a comprehensive set of repairs for the iPhone 5. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 5. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/5.jpg',
  imageSrc2: '/iphone/devices/5-rear.jpg',
  imageAlt: 'Image of an iPhone 5.',
  imageAlt2: 'Image of the rear of an iPhone 5.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 5', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-5-repairs/" />
