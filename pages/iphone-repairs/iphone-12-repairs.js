...
const product = {
  ...
  model: 'iPhone 12',
  description: "We offer a comprehensive set of repairs for the iPhone 12. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 12. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/12.jpg',
  imageSrc2: '/iphone/devices/12-rear.jpg',
  imageAlt: 'Image of an iPhone 12.',
  imageAlt2: 'Image of the rear of an iPhone 12.',
  breadcrumbs: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-12-repairs/" />
