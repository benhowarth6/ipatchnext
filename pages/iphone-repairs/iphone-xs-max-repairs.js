...
const product = {
  name: 'iPhone XS Max Repairs',
  model: 'iPhone XS Max',
  description: "We offer a comprehensive set of repairs for the iPhone XS Max. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone XS Max. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/xs-max.jpg',
  imageSrc2: '/iphone/devices/xs-max-rear.jpg',
  imageAlt: 'Image of an iPhone XS Max.',
  imageAlt2: 'Image of the rear of an iPhone XS Max.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone XS Max', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-xs-max-repairs/" />
