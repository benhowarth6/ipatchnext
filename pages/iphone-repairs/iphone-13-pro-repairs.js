...
const product = {
  name: 'iPhone 13 Pro Repairs',
  device_model: '13 Pro',
  description: "We offer a comprehensive set of repairs for the iPhone 13 Pro. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 13 Pro. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/13-pro.jpg',
  imageSrc2: '/iphone/devices/13-pro-rear.jpg',
  imageAlt: 'Image of an iPhone 13 Pro.',
  imageAlt2: 'Image of the rear of an iPhone 13 Pro.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 13 Pro', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-13-pro-repairs/" />
