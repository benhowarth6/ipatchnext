...
const product = {
  name: 'iPhone 5S Repairs',
  device_model: '5S',
  description: "We offer a comprehensive set of repairs for the iPhone 5S. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 5S. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/5s.jpg',
  imageSrc2: '/iphone/devices/5s-rear.jpg',
  imageAlt: 'Image of an iPhone 5S.',
  imageAlt2: 'Image of the rear of an iPhone 5S.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 5S', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-5s-repairs/" />
