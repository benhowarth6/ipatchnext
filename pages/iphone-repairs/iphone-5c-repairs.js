...
const product = {
  name: 'iPhone 5C Repairs',
  model: 'iPhone 5C',
  description: "We offer a comprehensive set of repairs for the iPhone 5C. Including screen replacements, batteries and much more.",
  meta: "We offer a comprehensive set of repairs for the iPhone 5C. Including screen replacements, batteries and much more.",
  imageSrc: '/iphone/devices/5c.jpg',
  imageSrc2: '/iphone/devices/5c-rear.jpg',
  imageAlt: 'Image of an iPhone 5C.',
  imageAlt2: 'Image of the rear of an iPhone 5C.',
  breadcrumbs: [
    { id: 1, name: 'iPhone Repairs', href: '/iphone-repairs' },
    { id: 2, name: 'iPhone 5C', href: '#' },
  ],
  highlights: [
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.ipatchrepairs.co.uk/iphone-repairs/iphone-5c-repairs/" />
