          ...
          <div className="px-0 sm:px-4 lg:px-0 lg:flex lg:justify-between lg:items-center">
            <div className="max-w-xl">
              ...
              <p className="mt-5 text-xl text-gray-200">
                Choose which type of device you need repairing.
              </p>
            </div>
          </div>
        </div>
              ...
              <Link href="iphoneRepair">
                <a className="block">
                  <div className="flex items-center px-2 py-4 sm:px-4">
                    ...
                    <div>
                      <Link href="iphoneRepair">
                        <a className="block w-full px-6 bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                          View
                        </a>
                      </Link>
                    </div>
