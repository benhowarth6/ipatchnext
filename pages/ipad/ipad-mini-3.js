...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="iPad Mini 3 Screen Replacement & Other Repairs in Leeds - iPatch"
        description="We repair iPad Mini 3 screens, batteries, charging ports and more. We aim to complete all repairs in the same day and include a 90 day warranty."
      />
      <Navigation />
