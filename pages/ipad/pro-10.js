...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="iPad Pro 10.5-inch Screen Replacement & Other Repairs in Leeds - iPatch"
        description="We repair iPad Pro 10.5-inch screens, batteries, charging ports and more. We aim to complete all repairs in the same day and include a 90 day warranty."
      />
      <Header />
