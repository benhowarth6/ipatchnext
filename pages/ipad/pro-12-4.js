        ...
        <div className="pt-12 sm:pt-16 lg:pt-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-base text-blue-600 font-semibold tracking-wide uppercase">4th Generation</h2>
              <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl lg:text-5xl">
                iPad Pro 12.9 Repair
          </h2>
              <p className="mt-4 text-xl text-gray-600">
                We offer a comprehensive set of repairs for the fourth generation iPad Pro 12.9-inch. Including screen replacements, batteries and much more.
          </p>
            </div>
          </div>
        </div>
              ...
              <div className="max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex">
                <div className="flex-1 bg-white px-6 py-8 lg:p-12">
                  ...
                  <p className="mt-6 text-base text-gray-500">
                    If the glass or LCD on the front of your iPad is cracked, you'll require a full screen replacement as all of the layers are laminated together.
              </p>
                  <div className="mt-8">
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto pb-24 px-4 sm:px-6 lg:px-8">
          <div className="sm:flex sm:flex-col sm:align-center">
            ...
            <p className="mt-4 text-xl text-gray-600 sm:text-center">Here's all the repairs we offer for iPad Pro 12.9-inch.</p>
          </div>
          <div className="mt-12 space-y-4 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 xl:grid-cols-4">
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <p className="mt-8">
                  <span className="text-4xl font-extrabold text-gray-900">£185</span>
                </p>
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                <h2 className="text-lg leading-6 font-medium text-gray-900">USB-C Charging Port</h2>
