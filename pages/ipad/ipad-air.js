...
import ipadAirModels from "../../data/ipad/ipadAirModels.json";
...
export default function Home() {
  return (
    <div>
      <NextSeo
        title="iPad Air Repairs in Leeds | Screen Replacements, Batteries and more"
        description="Expert iPad Air repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our iPad Air repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/ipad/ipad-air"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/ipad/ipad-air',
          title: 'iPad Air Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert iPad Air repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our iPad Air repairs include a 3 month warranty.',
          mages: [
            {
              ...
              width: 1200,
              height: 630,
              alt: "iPatch | iPad Air Repairs in Leeds"
            }
          ]
        }}
      />
      ...
      <div className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="mt-1 text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl">iPad Air Repairs</h1>
            <h2 className="max-w-2xl mt-5 mx-auto text-xl text-white">We offer a large selection of iPad Air repairs including screens, batteries, charging ports and more for all models. </h2>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8 hidden sm:grid">
        <div className="max-w-7xl mx-auto">
          ...
          {ipadAirModels.map(ipadAirModels => {
            const { id, model, image, alt, link } = ipadAirModels;
            return (
      ...
      <div className="bg-gray-50 pt-16 pb-20 lg:pt-24 lg:pb-28 lg:px-8 md:hidden">
        ...
        <div className="max-w-2xl mx-auto sm:px-6 pt-12">
          ...
          {ipadAirModels.map(ipadAirModels => {
            const { id, model, mobileimage, alt, link } = ipadAirModels;
            return (
      ...
      <div className="bg-white">
        <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
          <h2 className="text-3xl font-extrabold text-gray-800 tracking-tight">Everything needed for a great iPad Air repair</h2>
