...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="iPad 4 Repairs in Leeds | Screen Replacements, Batteries and more"
        description="Expert Apple iPad 4 repairs in Trinity Leeds. We offer replacement screens, batteries, charging ports and more while you wait. All of our iPad 4 repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/ipad/ipad-4"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/ipad/ipad-4',
          title: 'iPad 4 Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert Apple iPad 4 repairs in Trinity Leeds. We offer replacement screens, batteries, charging ports and more while you wait. All of our iPad 4 repairs include a 3 month warranty.',
          images: [
            {
              ...
              width: 1200,
              height: 630,
              alt: "iPatch | iPad 4 Repairs in Leeds"
            }
          ]
        }}
      />
                  ...
                  <div className="mt-6">
                    ...
                    <Link
                        href={{
                          ...
                          query: { model: "4", repair: "digitiser" },
                        }}
                      >
        ...
        <div className="max-w-7xl mx-auto pb-24 px-4 sm:px-6 lg:px-8">
          <div className="sm:flex sm:flex-col sm:align-center">
            ...
            <p className="mt-4 text-xl text-gray-600 sm:text-center">
              Here's all the repairs we offer for iPad 4.
            </p>
          </div>
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "4", repair: "charging-port" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "4", repair: "headphone-jack" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "4", repair: "front-camera" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "4", repair: "rear-camera" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "4", repair: "loudspeaker" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "4", repair: "button-fault" },
                  }}
                >
                  <a className="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">
                    Book Repair
            ...
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-sm divide-y divide-gray-200">
              <div className="p-6">
                ...
                <Link
                  href={{
                    pathname: "book-repair/booking-type",
                    query: { model: "4", repair: "liquid-damage" },
                  }}
                >
                  <a className="mt-8 flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-white hover:bg-gray-50">
                    Book an Inspection
      ...
      <div className="py-16 bg-gray-100 overflow-hidden lg:py-24">
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
          <div className="relative">
            ...
            <p className="mt-4 text-xl text-gray-600 sm:text-center">
              Why repair your iPad 4 with iPatch?
            </p>
          </div>
