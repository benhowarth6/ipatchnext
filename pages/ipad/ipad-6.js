...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="iPad 6 Repairs in Leeds | Screen Replacements, Batteries and more"
        description="Expert Apple iPad 6 repairs in Trinity Leeds. We offer replacement screens, batteries, charging ports and more while you wait. All of our iPad 6 repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/ipad/ipad-6"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/ipad/ipad-6',
          title: 'iPad 6 Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert Apple iPad 6 repairs in Trinity Leeds. We offer replacement screens, batteries, charging ports and more while you wait. All of our iPad 6 repairs include a 3 month warranty.',
          images: [
            {
              ...
              width: 1200,
              height: 630,
              alt: "iPatch | iPad 6 Repairs in Leeds"
            }
          ]
        }}
      />
