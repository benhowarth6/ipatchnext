...
import ipadModels from "../../data/ipad/ipadModels.json";
  ...
  return (
    <div>
      <NextSeo
        ...
        description="Expert iPad repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our iPad repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/ipad/ipad"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/ipad/ipad',
          title: 'iPad Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert iPad repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our iPad repairs include a 3 month warranty.',
          mages: [
            {
      ...
      <div className="bg-gray-50 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8 hidden sm:grid">
        <div className="max-w-7xl mx-auto">
          ...
          {ipadModels.map(ipadModels => {
            const { id, model, image, alt, link } = ipadModels;
            return (
      ...
      <div className="bg-gray-50 pt-16 pb-20 lg:pt-24 lg:pb-28 lg:px-8 md:hidden">
        ...
        <div className="max-w-2xl mx-auto sm:px-6 pt-12">
          ...
          {ipadModels.map(ipadModels => {
            const { id, model, mobileimage, alt, link } = ipadModels;
            return (
      ...
      <div className="bg-white">
        <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
          <h2 className="text-3xl font-extrabold text-gray-800 tracking-tight">Everything needed for a great iPad repair</h2>
