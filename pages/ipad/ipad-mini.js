    ...
    <div>
      ...
      <div className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="mt-1 text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl">iPad Mini Repairs</h1>
            <h2 className="max-w-2xl mt-5 mx-auto text-xl text-white">We offer a large selection of iPad Mini repairs including screens, batteries, charging ports and more for all models. </h2>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white">
        <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
          <h2 className="text-3xl font-extrabold text-gray-800 tracking-tight">Everything needed for a great iPad Mini repair</h2>
