...
export default function Home() {
  ...
  return (
    <div>
      <NextSeo
        title="iPad Mini 5 Screen Replacement & Other Repairs in Leeds - iPatch"
        description="We repair iPad Mini 5 screens, batteries, charging ports and more. We aim to complete all repairs in the same day and include a 90 day warranty."
      />
      <Header />
