...
import ipadProModels from "../../data/ipad/ipadProModels.json";
...
export default function Home() {
  return (
    <div>
      <NextSeo
        title="iPad Pro Repairs in Leeds | Screen Replacements, Batteries and more"
        description="Expert iPad Pro repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our iPad Pro repairs include a 3 month warranty."
        canonical="https://www.ipatchrepairs.co.uk/ipad/ipad-pro"
        openGraph={{
          type: 'website',
          url: 'https://www.ipatchrepairs.co.uk/ipad/ipad-pro',
          title: 'iPad Pro Repairs in Leeds | Screen Replacements, Batteries and more',
          description: 'Expert iPad Pro repairs in Trinity Leeds. We offer replacement screens, batteries and more while you wait. All of our iPad Pro repairs include a 3 month warranty.',
          mages: [
            {
              ...
              width: 1200,
              height: 630,
              alt: "iPatch | iPad Pro Repairs in Leeds"
            }
          ]
        }}
      />
      ...
      <div className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="mt-1 text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl">iPad Pro Repairs</h1>
            <h2 className="max-w-2xl mt-5 mx-auto text-xl text-white">We offer a large selection of iPad Pro repairs including screens, batteries, charging ports and more for all models. </h2>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8 hidden sm:grid">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-4 lg:max-w-none">
            {ipadProModels.filter(ipadProModels => ipadProModels.size == 12).map(filterediPadProModel=> (
              <div key={filterediPadProModel.id} className="flex flex-col rounded-lg shadow-lg overflow-hidden">
                <div className="flex-shrink-0 bg-white">
                <Link href={filterediPadProModel.link}>
                <a>
                    <Image
                      src={filterediPadProModel.image}
                      alt={filterediPadProModel.alt}
          ...
          <div className="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-4 lg:max-w-none">
            {ipadProModels.filter(ipadProModels => ipadProModels.size == 11).map(filterediPadProModel=> (
              <div key={filterediPadProModel.id} className="flex flex-col rounded-lg shadow-lg overflow-hidden">
                <div className="flex-shrink-0 bg-white">
                <Link href={filterediPadProModel.link}>
                <a>
      ...
      <div className="bg-gray-50 pt-16 pb-20 lg:pt-24 lg:pb-28 lg:px-8 md:hidden">
        ...
        <div className="max-w-2xl mx-auto sm:px-6 pt-6">
          ...
          {ipadProModels.filter(ipadProModels => ipadProModels.size == 12).map(filterediPadProModel=> (
            <li key={filterediPadProModel.id} className="bg-white hover:bg-gray-50 shadow overflow-hidden px-4 py-4 sm:px-6 sm:rounded-md">
              <Link href={filterediPadProModel.link}>
                <a className="block ">
                  <div className="flex items-center sm:px-6">
                    <div className="min-w-0 flex-1 flex items-center">
                      <div className="flex-shrink-0">
                        <Image
                          src={ filterediPadProModel.mobileimage }
                          alt={ filterediPadProModel.alt }
      ...
      <div className="bg-white">
        <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
          <h2 className="text-3xl font-extrabold text-gray-800 tracking-tight">Everything needed for a great iPad Pro repair</h2>
