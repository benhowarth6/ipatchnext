                            ...
                            {({ active }) => (
                              <div className="px-5 py-5 bg-gray-50 sm:px-6 sm:py-6">
                                ...
                                <div className="mt-5 text-sm">
                                  <Link href="/iphoneRepair">
                                    <a className="font-medium text-blue-600 hover:text-indigo-500 transition ease-in-out duration-150"> View all models <span aria-hidden="true">→</span></a>
                                  </Link>
                                </div>
                              </div>
                            )}
                          ...
                          <Menu.Item>
                            {({ active }) => (
                              <div className="px-5 py-5 bg-gray-50 sm:px-6 sm:py-6">
                                ...
                                <div className="mt-5 text-sm">
                                  <a href="/" className="font-medium text-blue-600 hover:text-indigo-500 transition ease-in-out duration-150"> View all models <span aria-hidden="true">→</span></a>
                                </div>
                              </div>
                            )}
                          </Menu.Item>
                ...
                <div className="mt-6">
                  <nav className="grid gap-y-8">
                    ...
                    <a className="flex items-start p-3 -m-3 rounded-lg hover:bg-gray-50" >
                      <span className="inline-flex ml-3 text-base font-medium text-gray-900">Home</span>
                    </a>
                    </Link>

                    <Link href="/about">
                    <a className="flex items-start p-3 -m-3 rounded-lg hover:bg-gray-50" >
                      <span className="inline-flex ml-3 text-base font-medium text-gray-900">About us</span>
                    </a>
                    </Link>

                    <Link href="/iphoneRepair">
                    <a className="flex items-start p-3 -m-3 rounded-lg hover:bg-gray-50" >
                      <span className="inline-flex ml-3 text-base font-medium text-gray-900">iPhone Repairs</span>
                    </a>
                    </Link>

                    <Link href="/ipadRepair">
                    <a className="flex items-start p-3 -m-3 rounded-lg hover:bg-gray-50" >
                      <span className="inline-flex ml-3 text-base font-medium text-gray-900">iPad Repairs</span>
                    </a>
                    </Link>

                    <Link href="/macRepair">
                    <a className="flex items-start p-3 -m-3 rounded-lg hover:bg-gray-50" >
                      <span className="inline-flex ml-3 text-base font-medium text-gray-900">Mac Repairs</span>
                    </a>
                    </Link>

                    <Link href="/watchRepair">
                    <a className="flex items-start p-3 -m-3 rounded-lg hover:bg-gray-50" >
                      <span className="inline-flex ml-3 text-base font-medium text-gray-900">Apple Watch Repairs</span>
                    </a>
                    </Link>

                    <Link href="/contact">
                    <a className="flex items-start p-3 -m-3 rounded-lg hover:bg-gray-50" >
                      <span className="inline-flex ml-3 text-base font-medium text-gray-900">Contact us</span>
                    </a>
                    </Link>
