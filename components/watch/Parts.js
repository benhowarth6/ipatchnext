            ...
            <div className="mt-16 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
              <div>
                <div className="w-full aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
                  <img
                    src="https://images.unsplash.com/photo-1593176439379-f55c105c021f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3870&q=80"
                    alt="Drawstring top with elastic loop closure and textured interior padding."
                    className="w-full h-full object-center object-cover"
                  />
                </div>
                <p className="mt-8 text-base text-gray-500">
                A prime example would be with repairing smashed glass on the rear of Apple Watch’s. A lot of repair shops will try and melt off the existing glass to then bond another piece on to the existing frame. 
                ...
                <p className="mt-8 text-base text-gray-500">
                The wireless charging coil can easily be damaged which, as it is connected to your volume buttons, can cause them to fail. Resulting in a poor fit meaning the Apple Watch is much less water resistant against any future mishaps.
                </p>
                <p className="mt-8 text-base text-gray-500">
                Here at iPatch we choose to replace not only the rear glass but the entire frame as well. Yes it is a bit more time consuming and certainly more of an expensive option but the results leave you with an Apple Watch looking like it did fresh out the box.
                </p>
              </div>
              <div>
                <div className="w-full aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
                  <img
                    src="https://images.unsplash.com/photo-1623930279525-132c3b295856?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3870&q=80"
