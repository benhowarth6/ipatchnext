            ...
            <div>
              <div className="w-full aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
                <div className="w-full h-full object-center object-cover">
                  <Image
                    alt="iPad with smart keyboard on lock screen."
              ...
              <p className="mt-8 text-base text-gray-500">
                All the components we use to repair iPads are original OEM quality parts. For some of the almost antique models, we do have to use refurbished components as the bits simply aren’t produced any more.
                ...
                For the newer models of iPads and all the replacement batteries we fit, the parts are supplied straight from the factory.
              </p>
            </div>
            <div>
              <div className="w-full aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
                <div className="w-full h-full object-center object-cover">
                  <Image
                    alt="Two iPads with smart keyboard on home screen."
