        ...
        <div className="max-w-2xl mx-auto px-4 lg:max-w-none">
          <div className="grid grid-cols-1 items-center gap-y-10 gap-x-16 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-2 text-4xl font-extrabold tracking-tight text-gray-900 dark:text-gray-200">We built our business on great customer service</p>
              ...
              <p className="mt-4 text-gray-500 dark:text-gray-400">We focus heavily on the quality of our repairs and parts to ensure you have a seamless experience with us. We don’t use cheap components, ensuring your device retains its original quality and features.</p>
            </div>
            <div className="aspect-w-3 aspect-h-2 bg-gray-100 dark:bg-gray-800/50 rounded-lg overflow-hidden">
            ...
            {incentives.map((incentive) => (
              <div key={incentive.name} className="sm:flex lg:block">
                ...
                <div className="mt-4 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
                  <h3 className="text-sm font-medium text-gray-900 dark:text-gray-200">{incentive.name}</h3>
