          ...
          <div className="grid grid-cols-1 items-center gap-y-10 gap-x-16 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-gray-500">
                Let’s be honest. When it comes to device repair there’s a number of options out there. In today’s world people rely on their Mac's more than ever. For people who want high quality, swift repairs, iPatch are here to help. Our focussed experience in the repair of Apple Devices mean we’re able to repair just about anything.
              </p>
              <p className="mt-4 text-gray-500">We focus heavily on the quality of our repairs and parts to ensure you have a seamless experience with us. We don’t use cheap components, ensuring your Mac retains its original quality and features.</p>
            </div>
            <div className="aspect-w-3 aspect-h-2 bg-gray-100 rounded-lg overflow-hidden">
              <div className="object-center object-cover">
                <Image
                  alt="Back of a MacBook Pro."
