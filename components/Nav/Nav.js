...
const Nav = () => {
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
      <span class="ml-3 text-xl">iPatchNext</span>
    ...
    <nav class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center">
      ...
      <a href="/iphoneRepair" class="mr-5 hover:text-gray-900">iPhone Repair</a>
      <a class="mr-5 hover:text-gray-900">Mac Repair</a>
      <a class="mr-5 hover:text-gray-900">iPad Repair</a>
      <a class="mr-5 hover:text-gray-900">Watch Repair</a>
      <a class="mr-5 hover:text-gray-900">iPod Repair</a>
